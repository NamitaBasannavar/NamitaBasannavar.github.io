...
<body>
	<header> <span id="title">truYum</span> <img
		...
		href="ShowMenuItemListCustomer">Menu</a> <a id="cart" href="ShowCart">Cart</a>
	</nav></header>
	...
	<table class="cont">
		...
		<c:forEach items="${menuItemList}" var="m">
			<tr>
				...
				<td class="al-mid"><c:if test="${m.freeDelivery}">Yes</c:if> <c:if
						test="${!m.freeDelivery}">No</c:if></td>
